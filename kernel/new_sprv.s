...
;        .DW         $EA60   ;60000 Приоритет 7 (высший)
        .DW         $0003   ;3мс  Приоритет 0 (низший)
        .DW         $0005   ;5мс  Приоритет 1 (фоновый)
        .DW         $0008   ;8мс  Приоритет 2 (пользовательский)
        .DW         $000A   ;10мс Приоритет 3 (пользовательский)
        .DW         $0014   ;20мс Приоритет 4 (пользовательский)
        .DW         $001E   ;30мс Приоритет 5 (пользовательский)
        .DW         $0028   ;40мс Приоритет 6 (системный)
        .DW         $003C   ;60мс Приоритет 7 (высший)
